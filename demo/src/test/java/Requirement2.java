...
public class Requirement2 {
    ...
    public Requirement2(int code, String name, String description, Double price, String unit, int amount, int result) {
        this.code = code;
        this.name = name;
    ...
    @Test
    public void ItShouldRegisterAProduct() {
        ProductInfo info = new ProductInfo(code, name, description);
        Product p = new Product(info, price, unit, amount);
